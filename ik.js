...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    function setUp(canvas_pass, style = "#000000") {
        ...
        function continued_stimuli(e) {
            ...
            TIP_engine.y = YS_engine
            TIP_engine.body = TIP_engine
            arm.target.x = TIP_engine.x
            arm.target.y = TIP_engine.y
        }
    }
...
//         console.log(gamepadAPI.axesStatus[1]*gamepadAPI.axesStatus[0]) //debugging
    ...
    class Arm {
        constructor(){
            ...
            this.lengths = []
            this.links = []
            this.target = new Circle(300,300, 1, "red")

            for(let t = 0;t<this.segs;t++){
                this.lengths.push((Math.random()*50)+50)
            }
            ...
            this.checker = new LineOP(this.points[this.points.length-1], this.target)
        }
        normalize(){
            ...
            for(let t = 0;t<this.points.length;t++){
                // if(t > 0){
                    ...
                    if(this.checker.hypotenuse() > check){
                        this.angles[t]-=.02
                    }else if(this.checker.hypotenuse() < check-5){
                        this.angles[t]+=.01
                    }
                // }
            }
